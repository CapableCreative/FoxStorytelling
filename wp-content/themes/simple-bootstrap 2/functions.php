...
function simple_bootstrap_theme_scripts() { 
    ...
    wp_register_style( 'sass-styles', get_stylesheet_directory_uri() . '/SASS.css', array(), null, 'all' );
...
?>
    ...
    <ul class="meta text-muted list-inline">
        ...
        <li>
            <?php
                $sp = '<i class="fa fa-comment" aria-hidden="true"></i> ';
...
function simple_boostrap_display_post($multiple_on_page) { ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class("block"); ?> role="article">
        ...
        <header>
            ...
            <?php else: ?>
            <div class="article-header">
                <h1 style="font-family: 'Zilla Slab','Helvetica Neue', helvetica, sans-serif;font-weight: 900;color:#CCC;font-size: 60px; font-style: italic;"><?php the_title(); ?></h1>
            </div>
            <?php endif ?>
